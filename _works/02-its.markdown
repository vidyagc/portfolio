...
<h5><i class="fa fa-music" aria-hidden="true" style="color:#856fa6;"></i>&nbsp;&nbsp;'With a Little Help From My Friends' <i class="fa fa-music" aria-hidden="true" style="color:#856fa6;"></i></h5>
<div class="page-content-text">
