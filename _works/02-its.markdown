...
<h5><i class="fa fa-music" aria-hidden="true" style="color:#927fb0;"></i>&nbsp;&nbsp;'With a Little Help From My Friends' <i class="fa fa-music" aria-hidden="true" style="color:#927fb0;"></i></h5>
<div class="page-content-text">
