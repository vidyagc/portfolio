...
<div class="row">
    <div class="col-sm-12">
        ...
        <img src="{{site.baseurl}}/img/portfolio/ITS-banner-highlight.png" style="display:inline; margin-right:15px" class="img-responsive img-centered img-padded">
        </div>
    </div>
</div>
...
<div class="row">
    <div class="col-md-12">
        <div class="resp-img-page" style="display:table; margin: auto">
        <img src="{{site.baseurl}}/img/portfolio/ITS-theory.jpeg" style="display:inline; margin-right:15px" class="img-responsive img-centered img-padded">
        </div>
    </div>
</div>
