...
<h5><i class="fa fa-music" aria-hidden="true" style="color:#0da5a5;"></i>  'With a Little Help From My Friends' <i class="fa fa-music" aria-hidden="true" style="color:#ec8013;"></i></h5>
<div class="page-content-text">
